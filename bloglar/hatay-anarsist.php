...
if ($blog) {
    ...
    $link = "https://localhost/hatay/bloglar/".createSafeFileName($baslik);
    ...
    if ($resimOlsunMu == "Evet") {
        ...
        $ekstraResim = "http://localhost/hatay/admin/" . $ekstraResim;
    }
                                            ...
                                            <div class="post_content" bis_skin_checked="1">
                                                ...
                                                <div class="post_body entry-content uk-margin-large-bottom" id="post_body_4536402983010354906" data-uk-lightbox="toggle:a[imageanchor]" bis_skin_checked="1">
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php if($extrapicture == true) {

?>                                                             <img alt="Image" loading="lazy" src="<?php echo $ekstraResim; ?>" width="400" height="700">
                                                        ...
                                                        <?php } else if ($aciklama2ResimKonumu == "sag") { ?>
                                                            <div class="uk-padding-medium" style="background:#888;color:#FFF" bis_skin_checked="1">
                                                                <div class="uk-grid-medium uk-grid" data-uk-grid="" bis_skin_checked="1">
                                                                    ...
                                                                    <div class="uk-width-1-3@m uk-first-column image-wrapper" bis_skin_checked="1">
                                                                        <a href="#" imageanchor="1" data-type="image">
                                                                            <img src="https://localhost/hatay/admin/<?= $aciklama2Resim ?>" border="0">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="post_footer_line post_footer_line_2" bis_skin_checked="1">
                                                        <div class="post_share uk-margin-right uk-margin-small-bottom" bis_skin_checked="1"><span class="post_share_label"><span class="uk-icon uk-margin-small-right" data-uk-icon="icon:social;ratio:.75"><svg width="15" height="15" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="social">
                                                            ...
                                                            <ul class="post_share_buttons uk-iconnav uk-text-center uk-margin-remove">
                                                                <li class="uk-padding-remove"><span class="icon_facebook uk-icon-button uk-icon" data-href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $link; ?>" data-uk-icon="facebook" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="facebook">
                                                                            <path d="M11,10h2.6l0.4-3H11V5.3c0-0.9,0.2-1.5,1.5-1.5H14V1.1c-0.3,0-1-0.1-2.1-0.1C9.6,1,8,2.4,8,5v2H5.5v3H8v8h3V10z"></path>
                                                                        </svg></span></li>
                                                                <li class="uk-padding-remove"><span class="icon_twitter uk-icon-button uk-icon" data-href="https://twitter.com/intent/tweet?text=<?php echo $link; ?>" data-uk-icon="twitter" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="twitter">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_whatsapp uk-icon-button uk-icon" data-href="https://wa.me/?text=<?php echo $link; ?>" data-uk-icon="whatsapp" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="whatsapp">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_telegram uk-icon-button uk-icon" data-href="https://t.me/share/url?url=<?php echo $link; ?>&amp;txt=&amp;quot; Video" data-uk-icon="telegram" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="telegram">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_pinterest uk-icon-button uk-icon" data-href="https://pinterest.com/pin/create/button/?url=<?php echo $link; ?>&amp;media=https://lh3.googleusercontent.com/blogger_img_proxy/AAOd8Myzal4O1Ecgp4z4HY-7JcXaEj5rWM8yNk82Yv8MJTAkLYyiw-0Y6XEbgh3JOZgDrYRsdvcW-p7bzg2XjcR1vCcreUOWb9BToP_zNymt7svUnkCv&amp;description=&amp;quot; Video" data-uk-icon="pinterest" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="pinterest">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_reddit uk-icon-button uk-icon" data-href="https://www.reddit.com/submit?url=<?php echo $link; ?>&amp;title=&amp;quot; Video" data-uk-icon="reddit" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="reddit">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_linkedin uk-icon-button uk-icon" data-href="https://www.linkedin.com/shareArticle?url=<?php echo $link; ?>&amp;title&amp;quot; Video" data-uk-icon="linkedin" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="linkedin">
                                                                            <path d="M5.77,17.89 L5.77,7.17 L2.21,7.17 L2.21,17.89 L5.77,17.89 L5.77,17.89 Z M3.99,5.71 C5.23,5.71 6.01,4.89 6.01,3.86 C5.99,2.8 5.24,2 4.02,2 C2.8,2 2,2.8 2,3.85 C2,4.88 2.77,5.7 3.97,5.7 L3.99,5.7 L3.99,5.71 L3.99,5.71 Z"></path>
                                                                            <path d="M7.75,17.89 L11.31,17.89 L11.31,11.9 C11.31,11.58 11.33,11.26 11.43,11.03 C11.69,10.39 12.27,9.73 13.26,9.73 C14.55,9.73 15.06,10.71 15.06,12.15 L15.06,17.89 L18.62,17.89 L18.62,11.74 C18.62,8.45 16.86,6.92 14.52,6.92 C12.6,6.92 11.75,7.99 11.28,8.73 L11.3,8.73 L11.3,7.17 L7.75,7.17 C7.79,8.17 7.75,17.89 7.75,17.89 L7.75,17.89 L7.75,17.89 Z"></path>
                                                                        </svg></span></li>
                                                                <li class="uk-padding-remove"><span class="icon_tumblr uk-icon-button uk-icon" data-href="https://www.tumblr.com/share/link?url=<?php echo $link; ?>&amp;name=&amp;quot; Video" data-uk-icon="tumblr" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="tumblr">
                                                                ...
                                                                <li class="uk-padding-remove"><span class="icon_copy uk-icon-button uk-icon" data-copy="<?php echo $link; ?>" data-uk-icon="copy" data-uk-tooltip="pos:top" role="button" title="" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="copy">
                                            ...
                                            <li>
                                                <div class="item-content" bis_skin_checked="1">
                                                    <div class="item-thumbnail uk-text-center uk-position-relative uk-transition-toggle" bis_skin_checked="1">
                                                        <a href="<?php  echo createSafeFileName($blogBaslik); ?>"> <!-- Bu href'i blog postunun linki ile güncelleyebilirsiniz -->
                                                    ...
                                                    <div class="item-title" bis_skin_checked="1">
                                                        <a href="<?php  echo createSafeFileName($blogBaslik); ?>"><?php echo $blogBaslik; ?></a> <!-- Bu href'i blog postunun linki ile güncelleyebilirsiniz -->
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="item-content uk-transition-toggle" bis_skin_checked="1">
                                                        <div class="item-thumbnail uk-text-center" bis_skin_checked="1">
                                                            <a class="uk-position-relative uk-overflow-hidden" href="<?php echo "http://localhost/hatay/admin/". createSafeFileName($blog['blogBaslik']); ?>"> <!-- Bu href'i blog postunun linki ile güncelleyebilirsiniz -->
                                                        ...
                                                        <div class="item-title" bis_skin_checked="1">
                                                            <a href="<?php echo "http://localhost/hatay/admin/". createSafeFileName($blog['blogBaslik']); ?>"><?php echo $blog['blogBaslik']; ?></a> <!-- Bu href'i blog postunun linki ile güncelleyebilirsiniz -->
                                                        </div>
