        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">ADMİN</span>
                </a>
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                <li class="menu nav-item">
                    <button type="button" class="nav-link group active" :class="{'active' : activeDropdown === 'dashboard'}" @click="activeDropdown === 'dashboard' ? activeDropdown = null : activeDropdown = 'dashboard'">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li>
                            <a href="adduser.php">Kullanıcı Ekleme</a>
                        </li>
                        <li>
                            <a href="listblog.php">Blog Listesi</a>
                        </li>
                        <li>
                            <a href="addblog.php">Blog Ekleme</a>
                        </li>
                        <li>
                            <a href="editblog.php">Blog Düzenleme</a>
                        </li>
                        <li>
                            <a href="listdonatebook.php">Bağış Yapılacak Kitap Listesi</a>
                        </li>
                        <li>
                            <a href="banks.php">Bank's Account</a>
                        </li>
                    </ul>
        </div>
    </nav>
